...
(function () {
  ...
  /* ============================================================
     4. LEAD FORM
     Moved to assets/nacravo-lead.js. The form is no longer a WhatsApp link
     dressed as a quote request: it is a three-step qualification flow that
     POSTs to /api/leads and only announces success — and only pushes
     generate_lead / lead_created — once the server has stored the lead.
     Do not re-add a #leadForm submit handler here; two handlers would create
     two leads and two conversions from one customer action.
     ============================================================ */
